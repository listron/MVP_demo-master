...
public class SencondPresenter<T extends MainView> extends BasePresenter<T> {

    public SencondPresenter(Context context) {
        super(context);
    }
